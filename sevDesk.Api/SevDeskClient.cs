...
namespace sevDesk.Api
{
	public class SevDeskClient : ISevDeskClient
	{
		...
		public SevDeskClient(IServiceProvider serviceProvider)
		{
			...
			if (_options.TokenProviderType != null)
			{
				var tokenProvider = (ISevDeskTokenProvider)Activator.CreateInstance(_options.TokenProviderType);
